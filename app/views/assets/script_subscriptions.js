function drawEventSubcriptions(resp) {
    ...
    if (
        document
            .querySelector("#func_got_conduit_subscriptions_header button")
...
function deleteSubscription(e) {
    ...
    actuallyRemoveAction = function () {
        ...
        window.electron.twitchAPI("deleteSubscription", {
...
create_subscription_form.addEventListener("submit", (e) => {
    ...
    let fields = create_subscription_condition.querySelectorAll(
        'input[name="create_subscription_condition_field[]"]',
    );
    let values = create_subscription_condition.querySelectorAll(
        'input[name="create_subscription_condition_value[]"]',
    );
